...
@section('content')
    ...
    <div class="row mt-5 mb-4 px-2">
        <a href="{{ route('front.admin') }}" class="mt-5 col col-md-2 btn btn-sm btn-dark ms-auto"><i class="fa fa-reply"></i> Regresar</a>
    </div>

    <div class="row pb-5">
        <div class="col-xxl-6 col-xl-6 col-lg-9 col-md-12 col-sm-12 col-12 mx-auto text-center my-3">
			<div class="card">
				<form action="{{ route('politics.update', $politicas[0]->id) }}" method="post" class="card-body">
					@csrf
					@method('put')
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-9 col-md-12 col-sm-12 col-12 mx-auto text-center my-3">
			<div class="card">
				<form action="{{ route('politics.update', $politicas[1]->id) }}" method="post" class="card-body">
					@csrf
					@method('put')
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-9 col-md-12 col-sm-12 col-12 mx-auto text-center my-3">
			<div class="card">
				<form action="{{ route('politics.update', $politicas[2]->id) }}" method="post" class="card-body">
					@csrf
					@method('put')
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-9 col-md-12 col-sm-12 col-12 mx-auto text-center my-3">
			<div class="card">
				<form action="{{ route('politics.update', $politicas[3]->id) }}" method="post" class="card-body">
					@csrf
					@method('put')
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-9 col-md-12 col-sm-12 col-12 mx-auto text-center my-3">
			<div class="card">
				<form action="{{ route('politics.update', $politicas[4]->id) }}" method="post" class="card-body">
					@csrf
					@method('put')
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-9 col-md-12 col-sm-12 col-12 mx-auto text-center my-3">
			<div class="card">
				<form action="{{ route('politics.update', $politicas[5]->id) }}" method="post" class="card-body">
					@csrf
					@method('put')
